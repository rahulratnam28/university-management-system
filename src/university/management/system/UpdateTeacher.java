...
public class UpdateTeacher extends JFrame implements ActionListener {
    ...
    UpdateTeacher(){
        ...
        JLabel lbrn = new JLabel("Select Employee Id");
        ...
        try{
            ...
            while(rs.next()){
                ...
                lbx.setText(rs.getString("ug"));
                lbx2.setText(rs.getString("pg"));
                lbadha.setText(rs.getString("adhar"));
                lbcou.setText(rs.getString("qualification"));
                lbbranch.setText(rs.getString("department"));
            }
        }
        catch(Exception e){
            e.printStackTrace();
   ...
   public void actionPerformed(ActionEvent ae) {
    ...
    public static void main(String[] args){
        UpdateTeacher as = new UpdateTeacher();
    }
}
