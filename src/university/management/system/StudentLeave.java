...
public class StudentLeave extends JFrame implements ActionListener{
    ...
    StudentLeave(){
        ...
        lbroll.setBounds(60,100,250,20);
        lbroll.setFont(new Font("Tahoma", Font.PLAIN, 20));
        add(lbroll);
        ...
        JLabel lbdate = new JLabel("Since When(Select Date)");
    ...
    public void actionPerformed(ActionEvent ae){
            if(ae.getSource() == submit){
               ...
               String query = "insert into studentleave values('" +rollno+ "','" +date+ "','" +day+ "','" +duration+ "')";
